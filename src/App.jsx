  ...
  return (
    <div className={`min-h-screen bg-slate-50 overflow-x-hidden`}>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        {showIntro && (
          <div 
            className={`absolute inset-0 z-20 bg-black flex items-center justify-center -mt-20 sm:mt-0 transition-opacity duration-500 ${introFading ? 'opacity-0' : 'opacity-100'}`}
          >
            <video 
              autoPlay 
              muted 
